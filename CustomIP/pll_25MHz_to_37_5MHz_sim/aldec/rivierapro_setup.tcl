...
# ACDS 15.1 193 win32 2017.03.23.20:27:08
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script can be used to simulate the following IP:
#     pll_25MHz_to_37_5MHz
...
# # End of template
# ----------------------------------------
# If pll_25MHz_to_37_5MHz is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_25MHz_to_37_5MHz"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_25MHz_to_37_5MHz.vho"
}
