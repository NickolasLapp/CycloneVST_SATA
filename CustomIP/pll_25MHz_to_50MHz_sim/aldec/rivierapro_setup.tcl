...
# ACDS 15.1 193 win32 2017.03.23.20:25:41
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If pll_25MHz_to_50MHz is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_25MHz_to_50MHz"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_25MHz_to_50MHz.vho"
}
